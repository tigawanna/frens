/**
 * @generated SignedSource<<38c58b991e20f6a2a62b3951f1ffa03d>>
...
export type MainFeedQuery$variables = {
  after?: string | null | undefined;
  first: number;
};
export type MainFeedQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"MainFeed_feedPosts">;
};
export type MainFeedQuery = {
  response: MainFeedQuery$data;
  variables: MainFeedQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "2e6eb71a9f82c2c868430bd1f2b22352",
    "id": null,
    "metadata": {},
    "name": "MainFeedQuery",
    "operationKind": "query",
...
(node as any).hash = "2a2389765e4bcf6c3d05e660f0586e68";
