...
import { FrenFollowers_user$key } from "./__generated__/FrenFollowers_user.graphql";
...
export const FrenFollowersPaginatedFragment = graphql`
  fragment FrenFollowers_user on Query 
  @argumentDefinitions(
